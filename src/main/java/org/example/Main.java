...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= shoppingCart.getItemCount(); i++) {
            ...
            shoppingCart.updateTotalCost(price, quantity);
        }

        System.out.println("-----------------------------------");
        System.out.println(rb.getString("total") + " " + currencyFormat.format(shoppingCart.getTotalCost()));
